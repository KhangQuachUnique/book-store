                ...
                <c:choose>
                        ...
                        <c:forEach var="book" items="${wishListBooks}">
                            <div class="white-list-item-display">
                                <div class="white-list-item">
                                    <a href="${pageContext.request.contextPath}/book-detail?id=${book.id}"
                                        ...
                                        <div class="white-list-item-part-2">
                                            ...
                                            <div class="white-list-item-price-section">
                                                <span class="white-list-item-price">
                                                    <fmt:formatNumber value="${book.price}" type="number" /> VND
                                                </span>
                                                <del class="white-list-item-price-old">
                                    ...
                                    <div class="actions">
                                        <svg class="heart-icon selected" data-book-id="${book.id}"
                    ...
                    <c:otherwise>
                        <div class="empty-wishlist">
                            ...
                            <a href="${pageContext.request.contextPath}/categories" class="btn btn-primary">Browse
                                Books</a>
                        </div>
                    </c:otherwise>
                </c:choose>
