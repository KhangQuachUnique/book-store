        ...
        <body>
            ...
            <div class="form-container">
                ...
                <%-- Xử lý chuẩn hóa số điện thoại --%>
                    <% String rawPhone=request.getParameter("phone"); String phone=null; if (rawPhone !=null &&
                        !rawPhone.isEmpty()) { // Loại bỏ ký tự không phải số phone=rawPhone.replaceAll("[^0-9]", "" );
                        // Thêm +84 nếu bắt đầu bằng 0 if (phone.startsWith("0")) { phone="+84" + phone.substring(1); }
                        } %>
                        ...
                        <form id="registerForm" class="login-form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="regPhone" name="phone" required placeholder="Ví dụ: 0987654321"
                                    pattern="0[0-9]{9,10}"
                                    title="Nhập số điện thoại hợp lệ, bắt đầu bằng 0, 10 hoặc 11 chữ số" <%=phone !=null
                                    ? "value='" + phone + "'" : "" %>>
                            </div>
