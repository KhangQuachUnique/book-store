                                            ...
                                            <div class="book-detail-content">
                                                ...
                                                <div class="book-info-section">
                                                    ...
                                                    <div class="book-rating-section">
                                                        <div class="rating-display">
                                                            ...
                                                            <span class="rating-text">
                                                                <fmt:formatNumber value="${book.ratingAverage}"
                                                                    type="number" maxFractionDigits="1" /> out of 5
                                                            </span>
                                                            <c:if test="${book.reviewCount > 0}">
                                                                <span class="review-count">(${book.reviewCount}
                                                                    reviews)</span>
                                                            </c:if>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="price-container">
                                                            ...
                                                            <c:if test="${hasDiscount}">
                                                                <span class="original-price">
                                                                    <fmt:formatNumber value="${book.originalPrice}"
                                                                        type="number" /> VND
                                                                </span>
                                                                <span class="discount-badge">${book.discountRate}%
                                                                    OFF</span>
                                                                <div class="savings-text">
                                                                    You save:
                                                                    <fmt:formatNumber value="${savings}"
                                                                        type="number" /> VND
                                                                </div>
                                                            </c:if>
                                                        </div>
                                                    ...
                                                    <div class="stock-section">
                                                        <div
                                                            class="stock-status ${inStock ? 'in-stock' : 'out-of-stock'}">
