...
<div class="book-detail-container">
    ...
    <nav class="breadcrumb">
        ...
        <a href="${pageContext.request.contextPath}/categories">Sách</a>
        <span class="separator">></span>
    ...
    <div class="book-detail-content">
        ...
        <div class="book-image-section">
            ...
            <div class="quick-actions">
                <c:if test="${inStock}">
                    <button class="btn btn-primary add-to-cart" data-book-id="${requestScope.book.id}">
                ...
                <button class="btn btn-secondary add-to-wishlist" data-book-id="${requestScope.book.id}">
        ...
        <div class="book-info-section">
            ...
            <div class="book-header">
                ...
                <p class="book-author">Tác giả: <span
            ...
            <div class="book-rating-section">
                <div class="rating-display">
                    ...
                    <span class="rating-text">
                        <fmt:formatNumber value="${book.averageRating}" type="number" maxFractionDigits="1"/> trên 5
                    </span>
                </div>
            </div>
            ...
            <div class="pricing-section">
                <div class="price-container">
                    ...
                    <c:if test="${hasDiscount}">
                        ...
                        <span class="discount-badge">GIẢM ${book.discountRate}%</span>
                        <div class="savings-text">
                            Bạn tiết kiệm: <fmt:formatNumber value="${savings}" type="number"/> VND
                        </div>
                    </c:if>
                </div>
            </div>
            ...
            <div class="book-details-section">
                ...
                <div class="details-grid">
                    ...
                    <c:if test="${not empty book.createdAt}">
                        <div class="detail-item">
                            <span class="detail-label">Thêm vào danh mục:</span>
    ...
    <div class="related-actions">
        <div class="action-buttons">
            <button class="btn btn-outline" onclick="window.history.back()">
                <i class="icon-arrow-left"></i> Quay Lại Trang Trước
            </button>
            <a href="${pageContext.request.contextPath}/categories"
               class="btn btn-outline">
                <i class="icon-grid"></i> Xem Thêm Sách
            </a>
        </div>
    </div>
</div>
