                        ...
                        <div class="card-content">
                            <form action="${pageContext.request.contextPath}/admin/user" method="post" class="form">
                                ...
                                <div class="checkbox-group">
                                    <input type="checkbox" id="isDefaultAddress" name="isDefaultAddress" value="true"
                                        class="checkbox">
                                ...
                                <div class="action-buttons">
                                    ...
                                    <a href="${pageContext.request.contextPath}/admin/user?action=viewAddresses&id=${userId}"
                                        class="btn btn-outline">Back to Addresses</a>
                                </div>
                            </form>
                        </div>
                    </div>
