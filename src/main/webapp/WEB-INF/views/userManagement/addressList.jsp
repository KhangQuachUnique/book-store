    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <html lang="en">
            ...
            <head>
                ...
                <link
                    href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;600&display=swap&subset=vietnamese"
                    rel="stylesheet">
                ...
                <div class="container">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="card-title">Addresses for ${user.name} (ID: ${user.id})</h1>
                        </div>
                        <div class="card-content">
                            <div class="nav-actions">
                                <a href="${pageContext.request.contextPath}/admin/user?action=newAddress&id=${user.id}"
                                    class="btn btn-secondary">Add New Address</a>
                                <a href="${pageContext.request.contextPath}/admin/user?action=view&id=${user.id}"
                                    class="btn btn-outline">Back to User Details</a>
                            </div>
                            <c:choose>
