<%-- Created by IntelliJ IDEA. User: kadfw Date: 9/13/2025 Time: 8:53 PM To change this template use File | Settings |
    File Templates. --%>
                                    ...
                                    <svg class="partial-star" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                        <defs>
                                            <linearGradient id="partialGrad" x1="0" y1="0" x2="100%" y2="0">
                                                ...
                                                <stop offset="${param.partialFraction * 100}%" stop-color="lightgray">
                                                </stop>
                                            </linearGradient>
                                        </defs>
