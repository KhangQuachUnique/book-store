...
public class JwtUtil {
    ...
    private static final String SECRET_KEY = "super-secret-key"; // TODO: Move to environment
                                                                 // variable
    ...
    private static String generateToken(String email, String tokenType, long expirationTime,
        ...
        var builder = JWT.create().withSubject(email).withClaim("type", tokenType)
    ...
    public static String generateAccessToken(String email, String role) {
        return generateToken(email, ACCESS_TOKEN_TYPE, ACCESS_TOKEN_EXPIRATION,
                Map.of("role", role));
    }
    ...
    public static String generateRefreshToken(String email, String role) {
        return generateToken(email, REFRESH_TOKEN_TYPE, REFRESH_TOKEN_EXPIRATION,
                Map.of("role", role));
    }
