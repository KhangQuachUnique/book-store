...
public class AuthFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) {
        // Initialize UserDao once for the filter lifecycle
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
       ...
       if (!loggedIn) {
           ...
           // User đã login - ensure user in session matches JPA entity
           ...
           if (session == null || session.getAttribute("user") == null) {
               try {
                   ...
                   if (userOpt.isPresent()) {
                       ...
                       // Store safe user object in session for JSP access
                   ...
                   System.err.println("AuthFilter: Error fetching user from database: " + e.getMessage());
                   loggedIn = false;
               }
           }
