...
/**
 * Validation utility class for common input validation operations.
 * Provides static methods for validating emails, phone numbers, and other common data formats
 * used in the BookieCake application.
 * 
...
public class ValidatorUtil {
     ...
     * Username must be 3-20 characters and contain only letters, numbers, dots, underscores, and hyphens.
     * 
     ...
     * Name must be 2-50 characters and contain only letters and spaces (including Vietnamese characters).
     * 
    ...
    /**
     * Validates a Vietnamese phone number format specifically.
     * Accepts formats like: 0123456789, +84123456789, 84123456789
     * 
